  ...
  return (
    <div className="min-h-screen bg-blue-50">
      <div className="relative h-[500px]">
        <Image src="/image/Parroquia_DHR.jpg" alt="Confirmación" fill className="object-cover object-center" priority />
        <div className="absolute inset-0 bg-blue-900/60" />
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          <h1 className="text-4xl md:text-5xl font-bold text-white drop-shadow-lg">Confirmación</h1>
          <p className="text-xl text-blue-100 mt-4 drop-shadow">El don del Espíritu Santo</p>
        </div>
      </div>

      <div className="container mx-auto px-6 py-16 max-w-4xl">
        {[
          { titulo: "¿Qué es la Confirmación?", contenido: `` },
