  ...
  return (
    <div className="min-h-screen bg-blue-50">
      <div className="relative h-[500px]">
        <Image src="/image/Parroquia_DHR.jpg" alt="Matrimonio" fill className="object-cover object-center" priority />
        <div className="absolute inset-0 bg-blue-900/60" />
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          <h1 className="text-4xl md:text-5xl font-bold text-white drop-shadow-lg">Matrimonio</h1>
          <p className="text-xl text-blue-100 mt-4 drop-shadow">El amor consagrado ante Dios</p>
        </div>
      </div>

      <div className="container mx-auto px-6 py-16 max-w-4xl">
        {[
          { titulo: "¿Qué es el Sacramento del Matrimonio?", 
            contenido: `` },
          { titulo: "Requisitos", 
            contenido: `` },
          { titulo: "Preparación matrimonial", 
            contenido: `` },
        ].map((s, i) => (
        ...
        <div className="bg-blue-900 rounded-2xl shadow-lg p-8 mb-8 text-white">
          ...
          <p className="text-blue-100">Para reservar fecha y más información, visítenos en la oficina parroquial con al menos 6 meses de anticipación. Teléfono: <strong>234-2463</strong> o WhatsApp: 
          <strong>
